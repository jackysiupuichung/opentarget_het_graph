...
RES = "headline_results/w3_retrain_eval"
OUT = "headline_results/w3_retrain_eval/plots/aggregation_divergence.png"
CUTOFFS = [10, 50, 100]
N_BOOT = 2000
...
DISPLAY = {"ots__all": "OTS", "rdg__no_time__positive": "RDG",
           "enc_hgt_w3": "HGT", "enc_gatv2_w3": "GATv2", "enc_rgcn_w3": "R-GCN", "enc_compgcn_w3": "CompGCN",
           "abl_score_w3": "HGT+s", "abl_novelty_w3": "HGT+n", "p3_eahgt_both_w3": "HGT+s,n",
           "gatv2_score_w3": "GAT+s", "gatv2_novelty_w3": "GAT+n", "gatv2_both_w3": "GAT+s,n"}
ORDER = ["OTS", "RDG", "HGT", "GATv2", "R-GCN", "CompGCN",
         "HGT+s", "HGT+n", "HGT+s,n", "GAT+s", "GAT+n", "GAT+s,n"]
